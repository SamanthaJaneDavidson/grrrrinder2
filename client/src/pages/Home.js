    ...
    >
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className="carousel2">
            Here you can connect with fellow dog owners to set up doggy play
            dates. <span>Grrrr'inder</span> provides a catered experience by
            allowing owners the ability to be more selective about the dogs
            their pet meets.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            Create a <span>Grrrr'inder</span> account and profile to get started
            today!
          </p>
        </Carousel.Caption>
      </Carousel.Item>
