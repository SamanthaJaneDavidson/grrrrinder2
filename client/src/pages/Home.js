...
const home = () => {
  return (
    <Carousel fade prevLabel={null} nextLabel={null} pause="hover" indicators={false}>
      <Carousel.Item>
        <img className="d-block w-100" src={backgroundImg1} alt="dogs with teddy bear" style={{ opacity: "0.8", height:"1000px"}}/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={backgroundImg2} style={{ opacity: "0.8", height:"1000px" }} alt="dogs meeting" />
      ...
      <Carousel.Item>
        <img className="d-block w-100" src={backgroundImg3} style={{ opacity: "0.8", height:"1000px" }} alt="dogs playing" />
