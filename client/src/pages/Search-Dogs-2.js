...
//           // dog[key] is the male or female key in the dog data array.
//           // Object.keys(boxClicked)[0] is the the key from the box that was clicked
//           console.log("What values are being compared? " + dog[key] + " " + Object.keys(boxClicked)[0])
...
//       // The first loop for the category of each sections (i.e.gender)
//       for (let current in checkboxFilter) {
//         let option1 = checkboxFilter[current]
//         // This loop then goes for each option of each category (i.e. male, female)
...
//       <Searchbar handleChange={handleChange} handleSearchboxChange={handleSearchboxChange} />
...
//             {/* <Card name={dog.name} image={dog.image} description={dog.description} /> */}
//             <Card />
